...
File naming: `<slugified-title>.md` — if a file with that name already exists, a 4-char hash suffix is appended (e.g. `mutekiya-ramen-a1b2.md`). Filenames use hyphens to match QMD's internal path normalization.
